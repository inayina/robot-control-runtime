...
| 文档 | 角色 | 是否决定当前任务 |
|---|---|---|
| [POST_AUDIT_LOCAL_DEVELOPMENT_SPEC.md](POST_AUDIT_LOCAL_DEVELOPMENT_SPEC.md) | **Current Gate**：本机 Operations/Observability/Diagnostics；Orange Pi 后置 | **是**；当前内部 milestone 为 **LD0** |
