...
- 现有 Orange Pi 4 Pro 4GB 的 B0–B3 证据记录的是厂商 **stock** 内核
...
**Gate**：本工作树默认 **24** 个 CTest target、**7** 个 vcan acceptance 场景和
**22** 个 fault-matrix 场景。正式关闭本 Gate 时以当次程序输出为准，不把旧
19/19 摘要或缺 vcan 的 Skip 写成 PASS。
