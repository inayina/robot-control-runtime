...
[本机后续开发 SPEC](plans/POST_AUDIT_LOCAL_DEVELOPMENT_SPEC.md)（LD0）。
...
| 看当前本机 Gate | [POST_AUDIT_LOCAL_DEVELOPMENT_SPEC.md](plans/POST_AUDIT_LOCAL_DEVELOPMENT_SPEC.md) | 当前 milestone 为 LD0；[计划入口](plans/README.md) |
