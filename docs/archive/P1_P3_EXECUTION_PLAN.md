...
> [V1_PHYSICAL_CAN_EXECUTION_PLAN.md](../plans/V1_PHYSICAL_CAN_EXECUTION_PLAN.md) 为准。

状态：P1/P2 实现完成；P3-A0/A1/A2 完成；P3-B **部分关闭**（B0–B3 有板上证据；
stock 无 CONFIG_CAN → 那批证据 `rcrd` 未常驻；可选 can1 软件链另记；B4 未关）
...
长期范围仍以 [SPEC](../../SPEC.md) 和
[后续开发路线](../plans/DEVELOPMENT_ROADMAP.md) 为准。本文只解释旧证据所用编号、owner
和 Gate，不再决定当前任务；当前执行只听
